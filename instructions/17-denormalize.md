...
1. Scroll a little farther to another **//To-Do:** comment around line **516**. Here, you need to add code that inserts a new sales order and updates the customer record by using transactional batch.
...
1. Select Ctrl+G, and then enter **531**.
...
1. Select Ctrl+G, and then enter **568**.
