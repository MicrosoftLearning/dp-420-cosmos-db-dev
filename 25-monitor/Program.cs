...
public class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        Container database2_salesOrder_container = await database2.CreateContainerIfNotExistsAsync(id: "salesOrder", partitionKeyPath: "/id", throughput: 10000);

        Database database3 = await client.CreateDatabaseIfNotExistsAsync("database-v3");
        Container database3_customer_container =await database3.CreateContainerIfNotExistsAsync(id: "customer", partitionKeyPath: "/id", throughput: 10000);
        Container database3_salesOrder_container =await database3.CreateContainerIfNotExistsAsync(id: "salesOrder", partitionKeyPath: "/id", throughput: 10000);
